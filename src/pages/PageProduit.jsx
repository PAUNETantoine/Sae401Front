...
function PageProduit() {
    ...
    useEffect(() => {
        const foundProduct = tabProduitsBoutique.find(p => p.nom === nom);
        setProduit(foundProduct);
    }, [nom, tabProduitsBoutique]);
        ...
        return (
            <>
                ...
                <div className="erreur">
                    ...
                    <p>Désolé, le produit "{nom}" n'existe pas.</p>
                </div>
                <Footer/>
            </>
        );
                    ...
                    <div className="PageProduit-actions">
                        <div className="PageProduit-tailles">
                            {produit.taille && produit.taille.map((taille, i) => (
                                <Bouton key={i} className={taille === tailleSelect ? "btn-action-select" : "btn-action"}
                                        texte={taille} onClick={() => setTailleSelect(taille)}/>
                            ))}
                        </div>
